...
def generate_equation():
    global first_number, second_number, operation, correct_answer,symbol, answers
...
def game_over():
    ...
    if question_number>=6 and achievement_5levels==False:
        ...
        achievement_unlocked_label=tk.Label(gameover_frame, text="Achievement unlocked: Beat 5 Levels! ", font=("Arial", 40), bg="#f9c74f", fg="233d24", bd=2, relief="solid")
